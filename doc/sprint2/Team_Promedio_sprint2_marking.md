...
## Tracking on trello  (max 24 marks) 
  ...
  - Is each pull request made from a separate branch for each individual task? (max 5 marks)
    ...
    Your Mark: 4 (ex: https://github.com/UTSCCSCC01/finalprojectf22-team-promedio/pull/14)
...
## Sprint Completion (Max 20 marks) 
  ...
  Your Mark: 16 / 20 (only 4 user stories completed.. no sign of subtasks)
...
## Documentation (max 1 mark)
  ...
  Your Mark: 1 / 1 (coz I saw it in the demo but the PDF failed to load)
